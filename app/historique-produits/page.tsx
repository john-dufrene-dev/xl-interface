...
import { ArrowUpDown, Tag, TrendingUp, TrendingDown, Search, X } from "lucide-react"
...
export default function HistoriqueProduitsPage() {
  ...
  const filteredData = historiqueProduits.filter((historique) => {
    ...
    if (globalSearch) {
      ...
      matchesGlobal = (
        historique.product_name.toLowerCase().includes(search) ||
        historique.field.toLowerCase().includes(search)
      )
    }
